...
- **下载系统**：画廊 + 归档多线程并发、下载优先级 + 抢占式调度、归档并发数控制、断点续传（.part / .bits）、下载完成自动消除更新标记、已下载/下载中画廊入口拦截
...
v1.3.1 聚焦在线搜索体验。后续将延续稳定性与性能主线：持续收敛下载稳定性与资源占用、完善跨设备进度同步、补充离线端更丰富的检索与维护能力，并探索搜索结果的进一步精准化。
